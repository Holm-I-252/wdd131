...
function validateForm(event) {
  ...
  let firstName = theForm.fullName.value;

  if (firstName !== "Bob") {
    console.log("First name is not Bob");
    isValid = false;
    errors.push("First name must be Bob");
  }
  let creditCardNumber = theForm.creditCardNumber.value;
